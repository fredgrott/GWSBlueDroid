...
public class SpectrumActivity extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cla_list_view);
        
        // 1. Your dataset
        List<Integer> spectrum = new ArrayList<Integer>();
        spectrum.add(R.drawable.cla_spectrum_01);
        spectrum.add(R.drawable.cla_spectrum_02);
        spectrum.add(R.drawable.cla_spectrum_03);
        spectrum.add(R.drawable.cla_spectrum_04);
        spectrum.add(R.drawable.cla_spectrum_05);
        spectrum.add(R.drawable.cla_spectrum_06);
        spectrum.add(R.drawable.cla_spectrum_07);
