...
public class CustomAdapterDemoActivity extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CityAdapter cityAdapter = new CityAdapter(this, R.layout.ssa_list_item_city, cities);
        ...
        SimpleSectionAdapter<City> sectionAdapter = new SimpleSectionAdapter<City>(this, 
                cityAdapter, R.layout.ssa_section_header, R.id.title, distanceSectionizer);
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if(view == null) {
                view = View.inflate(CustomAdapterDemoActivity.this, 
                        R.layout.ssa_list_item_city, null);
