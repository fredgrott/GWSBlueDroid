...
public class ExtendedListView extends ListView implements OnScrollListener {
	...
	public ExtendedListView(Context context, AttributeSet attrs, int defStyle) {
		...
		final int scrollBarPanelInAnimation = a.getResourceId(R.styleable.ExtendedListView_scrollBarPanelInAnimation, R.anim.asbp_in_animation);
		final int scrollBarPanelOutAnimation = a.getResourceId(R.styleable.ExtendedListView_scrollBarPanelOutAnimation, R.anim.asbp_out_animation);
		a.recycle();
