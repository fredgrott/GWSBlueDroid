...
public class MagicTextView extends TextView {
	...
	public void init(AttributeSet attrs){
		...
		if(attrs != null){
			...
			if(a.hasValue(R.styleable.MagicTextView_strokeMyColor)){
				float strokeWidth = a.getFloat(R.styleable.MagicTextView_strokeMyWidth, 1);
				int strokeColor = a.getColor(R.styleable.MagicTextView_strokeMyColor, 0xff000000);
