	...
	public void setOverScrollMode( int mode ) {
		...
		if ( mode != OVER_SCROLL_NEVER ) {
			if ( mEdgeGlowLeft == null ) {
				Drawable glow = getContext().getResources().getDrawable( R.drawable.hvlv_overscroll_glow );
				Drawable edge = getContext().getResources().getDrawable( R.drawable.hvlv_overscroll_edge );
