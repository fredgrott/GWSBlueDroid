 ...
 */
package gws.grottworkshop.gwsbluedroid.util;

import gws.grottworkshop.gwsbluedroid.GWSBDApplication;
import gws.grottworkshop.gwsbluedroid.image.ImageCache;
...
public class GWSBDUtils {
     ...
     */
    public static GWSBDApplication getGDApplication(Context context) {
        return (GWSBDApplication) context.getApplicationContext();
    }
