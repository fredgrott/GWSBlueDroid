 ...
 */
package gws.grottworkshop.gwsbluedroid.image;

import gws.grottworkshop.gwsbluedroid.GWSBDApplication.OnLowMemoryListener;
import gws.grottworkshop.gwsbluedroid.util.GWSBDUtils;
...
public class ImageCache implements OnLowMemoryListener {
    ...
    public ImageCache(Context context) {
        ...
        GWSBDUtils.getGDApplication(context).registerOnLowMemoryListener(this);
    }

    public static ImageCache from(Context context) {
        return GWSBDUtils.getImageCache(context);
    }
